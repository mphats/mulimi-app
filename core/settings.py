...
LOGIN_URL = "/login/"
CSRF_TRUSTED_ORIGINS = ["https://mulimi-xijh.onrender.com"]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Django backend that replaces Supabase Edge Functions for your app.",
    "VERSION": "1.0.0",
    "SERVE_INCLUDE_SCHEMA": False,
}

# API keys stored as env var comma-separated for simplicity
API_KEYS = [k.strip() for k in os.getenv("API_KEYS", "dev-key-123").split(",") if k.strip()]
